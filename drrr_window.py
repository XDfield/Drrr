...
"}")
        ...
        self.timeLabel.setStyleSheet("color:#464646;")
...
"}")
        ...
        Drrr.setTabOrder(self.closeBtn, self.textBrowser)

    def retranslateUi(self, Drrr):
        _translate = QtCore.QCoreApplication.translate
        Drrr.setWindowTitle(_translate("Drrr", "Drrr"))
        self.title_label.setText(_translate("Drrr", "              DRRR Chat Room"))
        ...
        self.ipInfo.setText(_translate("Drrr", "Disconnected"))
